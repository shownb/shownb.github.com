...
-   Hashes:
    ...
    -   首选: SHA256 (widely used), SHA512 (preferred), or SHA-3
...
* **警告: 很不幸,并没有显示RSA和ED25519可以对抗"量子计算"**[^239] **虽然他们现在没有被破解，不代表未来不会.或者他们被破解只是时间问题，而不是能不能被破解的问题.但是，在目前来看，没有更好的选择**
...
许多人认为，以隐私为导向的服务，如VPN或E-Mail提供商，由于其无记录政策或其加密方案，是安全的。不幸的是，这些人中的许多人忘记了所有这些供应商都是合法的商业实体，受其经营所在国家的法律约束。
